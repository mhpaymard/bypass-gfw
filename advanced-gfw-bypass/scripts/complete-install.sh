...
# Advanced GFW Bypass System - Complete Installation
# This script handles everything from uninstall to complete setup
...
echo "=========================================="
echo "🚀 Advanced GFW Bypass - Complete Install"
echo "=========================================="

# Step 1: Uninstall if exists
print_status "Step 1: Checking for existing installation..."
if [[ -f "/usr/local/bin/v2ray" ]] || [[ -f "/etc/systemd/system/v2ray.service" ]]; then
...
print_status "Step 2: Running main installation..."
bash install.sh

# Step 4: Fix V2Ray configuration
print_status "Step 3: Fixing V2Ray configuration..."
...
print_status "Step 5: Generating client configuration..."
